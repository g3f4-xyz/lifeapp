...
var GRAPHQL_ROUTE = '/graphql';
var BUILD_PATH = '/build';

var server = (0, _express2.default)();

server.use(_express2.default.static(process.cwd() + BUILD_PATH));
server.use(GRAPHQL_ROUTE, (0, _cors2.default)(), (0, _expressGraphql2.default)(function () {
  return {
    schema: _schema2.default, pretty: true, graphiql: true
  };
}));
server.listen(PORT, function () {
  return console.log('GraphQL server is now running on ' + HOST + ':' + PORT + GRAPHQL_ROUTE);
});
